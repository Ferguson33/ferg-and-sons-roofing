...
export const reportSections = [
  {
    title: "Satisfactory",
    body: "No work needed.",
    // Quiet color cue: left border only (not a filled box)
    outline: "border-steel-light border-l-[#2f6b3a]",
  },
  {
    title: "Monitor",
    body: "Not urgent. Recheck next year.",
    outline: "border-steel-light border-l-[#ca8a04]",
  },
  {
    title: "Maintenance required",
    body: "Needs repair on this visit, if it fits the included amount.",
    outline: "border-steel-light border-l-[#c45e12]",
  },
  {
    title: "Replacement recommended",
    body: "The roof needs to be replaced. We quote it and we install it.",
    outline: "border-steel-light border-l-red",
  },
] as const;
